...
#define    CUSTOM_VIDEO_SETUP	_T(KR_CUSTOM_VIDEO_SETUP)
#define KR_DEFAULT_VIDEO_SETUP	"<Default>"
#define    DEFAULT_VIDEO_SETUP	_T(KR_DEFAULT_VIDEO_SETUP)
...
#define KR_MAX_POINTS_PER_ACQ			(752*480)	// Used to be (2*1024) for the Aquilon; but a scanner that acquires a full image is envisaged.


#define VIDEOSETTINGS_FILE				_T("VideoSettings.ini");
typedef struct
{
	BYTE	LUT_Threshold;
	BYTE	LUT_Threshold_B;
	BYTE	LaserPower;
	BYTE	IntegrationTime;
	BYTE	IntegrationTime_B;
	BYTE	HardwareFilter;
	double	SoftwareFilter;
	BYTE	CleanEdges;						// Number of points to clean near edges: 0=Off; 2=Medium; 4=Strong
	bool	bAutoSettings;
	bool	bHighContrast;
	BYTE	HC_BlackOrWhite;				// 0 = Black ; 1 = White ; 2 = Both
	BYTE	HC_IntegrationTime_Black;		// \_ IT indices to use alternately in High Contrast mode.
	BYTE	HC_IntegrationTime_White;		// /  IT for Black is longer (smaller index) than for White.
	unsigned short	HC_LaserAreaCeiling;			// Maximum energy of the laser for "Black" acquisition in High Contrast mode (to reject White points).
	unsigned short	HC_LaserAreaThreshold;			// Minimum energy of the laser for "White" acquisition in High Contrast mode (to reject Black points).
	BYTE	AQC;							// Adjustment between Quality and Comfort
	bool	bAdvancedAQC;					// true if advanced AQC parameters are used
	bool	bDepthOfField;
	BYTE	DepthOfField;
	bool	bMaximumInclination;
	BYTE	MaximumInclination;
	bool	bIsolatedPointsRemoval;
	unsigned short	IsolatedPointsRemoval;
	bool	bExposureTolerance;
	unsigned short	ExposureTolerance;
	bool	bWidthOfField;
	BYTE	WidthOfField;
} KR_VIDEO_SETTINGS_PARAMETERS;

typedef struct
{
	bool	needsCalFile;						//  Obsolete (now always true): Tells whether the other fields are relevant or not
	...
	DWORD	listSize;							//	Number of bytes (including zeros) used by the list (listSize<=KR_CALIBRATION_FILE_LIST_SIZE)
...
typedef struct
{
	...
	double	Angles[3];						//	angles of the indexed head (unused with arms)
}	KR_INDEX;
...
typedef struct
{
	...
	double	Diameter;				//	Diameter of the probe (Diameter<=0 means that the diameter will be determined automatically by the arm if possible; otherwise |Diameter| will be used)
...
//	---------------------------------------------------------------------------
//	GetSensorType
#define	KR_SENSOR_UNKNOWN								0	// Unknown in this software version
#define	KR_SENSOR_KLS51									1	// KLS51 - obsolete
#define	KR_SENSOR_KLS171								2	// KLS171 - obsolete
#define	KR_SENSOR_ZLS50									3	// Zephyr KZ50
#define	KR_SENSOR_ZLS100								4	// Zephyr KZ100
#define	KR_SENSOR_ZLS25									5	// Zephyr KZ25
#define	KR_SENSOR_ALS50									6	// Aquilon (KA50)
#define	KR_SENSOR_SOLANO100								7	// Solano SL100
#define	KR_SENSOR_SKIRON75								8	// Skiron (KS75)
#define	KR_SENSOR_Z2_100								9	// ZephyrII Z2-100
#define	KR_SENSOR_SOLANOLITE100							10	// Solano Lite SLL100
#define	KR_SENSOR_SIMUSCAN								11	// Scanner Simulator
#define	KR_SENSOR_Z2_70									12	// ZephyrII Blue Z2-70
#define	KR_SENSOR_SOLANOBLUE100							13	// Solano Blue SB100
#define	KR_SENSOR_SOLANOBLUE60							14	// Solano Blue CMM SBC60
//#define KR_SENSOR_RESERVED							15
#define	KR_SENSOR_SKYLINE_WIDE_200						16	// Skyline Wide ASW200 (formely known as AS200)
#define	KR_SENSOR_SKYLINE_EYES_100						17	// Skyline Eyes ASE100 (formely known as AS100)
#define	KR_SENSOR_SKYLINE_OPEN_100						18	// Skyline Open ASO100 (formely known as ASL100)
...
#define	KR_ERR_ECU_NOT_CONNECTED						13		//	Obsolete, now equivalent to KR_ERR_SENSOR_NOT_CONNECTED
...
#define	KR_ERR_BAD_PARAMETER							27
...
#define	KR_ERR_DONGLE_NOT_FOUND							61
#define	KR_ERR_POSITIONING_WINDOW_NOT_OPENED			62
#define	KR_ERR_NO_SCAN_IN_PROGRESS						63
...
#define	KR_SOFTWARE_FILTER_MEDIUM					2
...
#define KR_SCAN_METHOD_BIT_POSITIONING				0x20
...
#define	KR_SCAN_METHOD_ASYNCHRONOUS_POSITIONING		(KR_SCAN_METHOD_ASYNCHRONOUS | KR_SCAN_METHOD_BIT_POSITIONING)
#define	KR_SCAN_METHOD_SYNCHRONOUS_POSITIONING		(KR_SCAN_METHOD_SYNCHRONOUS | KR_SCAN_METHOD_BIT_POSITIONING)
...
#define KR_CMD_VIDEOSETUP_WINDOW_RESIZED			((UCHAR)17)
...
//#define KR_ARM_UNABLE_TO_INITIALIZE_SOFTWARE	(-8)		//	obsolete
